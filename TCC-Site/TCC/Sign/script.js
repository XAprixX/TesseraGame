...
new Vue({
  ...
  created: function() {
    ...
    this.cardPassword = ""; // Limpa o campo de senha ao iniciar a página de login
  },
  mounted() {
  ...
  methods: {
    ...
    submitForm() {
      if (!this.cardName || !this.cardPassword) {
        alert("Por favor, preencha o nickname e senha antes de prosseguir.");
        return;
      }
