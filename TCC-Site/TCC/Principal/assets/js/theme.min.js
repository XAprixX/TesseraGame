...
!function() {
    "use strict";
    var t, e, r, a, n, o;
    null !== (e = document.querySelector('[data-bs-toggle="mode"]')) && (t = e.querySelector(".form-check-input"),
    "dark" === mode ? (root.classList.add("dark-mode"),
    t.checked = !0) : (root.classList.remove("dark-mode"),
    t.checked = !1),
    e.addEventListener("click", function(e) {
        t.checked ? (root.classList.add("dark-mode"),
        window.localStorage.setItem("mode", "dark")) : (root.classList.remove("dark-mode"),
        window.localStorage.setItem("mode", "light"))
    })),
    null != (a = document.querySelector(".navbar-sticky")) && (e = a.classList,
    r = a.offsetHeight,
    e.contains("position-absolute") ? window.addEventListener("scroll", function(e) {
        ...
        a.classList.add("navbar-stuck")) : (document.body.style.paddingTop = "",
    ...
    function() {
        ...
        if (0 !== a.length)
            for (var n = 0; n < a.length; n++)
                !function() {
                    var e, t = a[n], r = t.parentNode.querySelector(".credit-card-icon");
                    null != t.dataset.format && (e = JSON.parse(t.dataset.format)),
                    r ? new Cleave(t,_objectSpread(_objectSpread({}, e), {}, {
        ...
        if (!(e.length <= 0))
            for (var t = 0; t < e.length; t++)
                e[t].querySelector('[data-bs-toggle="price"]').addEventListener("change", function(e) {
                    for (var t = e.currentTarget.querySelector('input[type="checkbox"]'), r = e.currentTarget.closest(".price-switch-wrapper").querySelectorAll("[data-monthly-price]"), a = e.currentTarget.closest(".price-switch-wrapper").querySelectorAll("[data-annual-price]"), n = 0; n < r.length; n++)
                        1 == t.checked ? r[n].classList.add("d-none") : r[n].classList.remove("d-none");
                    for (var o = 0; o < r.length; o++)
                        1 == t.checked ? a[o].classList.remove("d-none") : a[o].classList.add("d-none")
                })
    }(),
    function() {
        ...
        if (0 !== v.length)
            for (var e = function() {
                var t = v[y]
                  ...
                  , s = null;
                e.addEventListener("click", function(e) {
                    i = "play" === i ? (e.currentTarget.classList.add("ap-pause"),
                    r.play(),
                    requestAnimationFrame(m),
                    "pause") : (e.currentTarget.classList.remove("ap-pause"),
                    r.pause(),
                ...
                0 < r.readyState ? (d(),
                p(),
                f()) : r.addEventListener("loadedmetadata", function() {
                    d(),
                    p(),
                    f()
                }),
